...
if __name__ == "__main__":
    ...
    psd_model = Lorentzian(variance_qpo, Q, w_qpo) + BendingPowerlaw(
        variance_drw, w_bend
    )

    simulator = Simulator(
        psd_model, times, np.ones(len(times)) * dt, mean, pdf="Gaussian", max_iter=500
    )
    ...
    corner_fig.savefig("corner_plot_celerite2_alt_period.png", dpi=100)
