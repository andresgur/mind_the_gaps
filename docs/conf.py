...
# -- Project information -----------------------------------------------------
project = pyproject['tool']['sphinx']['title']

author = f"{','.join(author['name'] for author in pyproject['project']['authors'])}"
copyright = f"{author}, {datetime.datetime.now().year}"

# The full version, including alpha/beta/rc tags
release = pyproject['project']['version']

# The short X.Y version
## SWM: I don't quite like this but eh it's the standard
